<div class="jumbotron bg-success col-12 text-center">
	<h3 class="text-white font-weight-bold">HASIL TEST</h3>
	<hr style="border: 3px solid white;">
	<div>
		<strong class="text-white d-flex text-uppercase">Nama Pelamar : <?= $this->session->userdata('nama_lengkap') ?></strong>
		<br>
		<strong class="text-white d-flex text-uppercase">Bagian Yang di Ambil : <?= $this->session->userdata('bagian') ?></strong>
	</div>
</div>
...
<div class="col-12 text-center mt-4" style="">
	<a class="btn btn-outline-pink text-success col-12">
...
<div class="col-12 text-center mt-4" style="">
	<button class="btn btn-success text-success" type="submit">
		<h5 class="font-weight-bold text-white">SELESAI</h5>
	</button>
</div>
</form>
