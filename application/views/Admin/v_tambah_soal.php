...
<div class="p-5">
  	...
  	<div class="fixed-top justify-content-end d-flex col-3" style="top: 80px;">
		<button type="button" name="tambah" id="tambah" class="btn btn-pink text-success">
			<i class="fas fa-plus text-white"> TAMBAH SOAL</i>
		</button>
	</div>
  	<div class="fixed-top justify-content-end d-flex col-2" style="top: 140px;">
		<button type="button" name="tambah" id="tambah" class="btn btn-outline-pink text-success">
				<div class="jum_soal text-pink font-weight-bold" style="font-size: 25px;">0</div>
		</button>
	</div>
</div>
